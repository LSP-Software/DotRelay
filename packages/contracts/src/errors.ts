...
const GENERIC_TITLES: Record<ProblemCode, string> = {
  ...
  github_identity_not_found: "GitHub identity not found",
  ...
  genesis_exists: "Genesis already exists",
  state_conflict: "State conflict",
  last_owner_protection: "Last owner protection",
