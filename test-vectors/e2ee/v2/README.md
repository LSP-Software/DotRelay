...
Values. No vector may be regenerated with a different suite, field registry, schema, or encoding
profile. Any change requires a new protocol decision and independent review.
